...
public class CourseDaoImpl implements CourseDao {
    ...
    public Course createNewCourse(Course course) {
        ...
        jdbcTemplate.update((Connection conn) -> {
            ...
            statement.setString(1, String.valueOf(course.getCourseName()));
            statement.setString(2, String.valueOf(course.getCourseDesc()));
    ...
    public void deleteAllStudentsFromCourse(int courseId) {
        ...
        final String deleteStudentsSql = "DELETE FROM course_student WHERE course_id = ?;";
        jdbcTemplate.update(deleteStudentsSql, courseId);
